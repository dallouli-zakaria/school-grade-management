...
if($lastInsertId)
{
$msg="Combinaison ajoutée avec succès";
}
else
{
...
<html lang="en">
    <head>
        ...
        <title>Ajouter une combinaison </title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Ajouter une combinaison</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Modules</li>
                                        <li class="active">Ajouter une combinaison</li>
                                    </ul>
                                </div>
