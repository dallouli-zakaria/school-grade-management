                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Ajouter un résultat</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Ajouter un résultat</li>
                                    </ul>
                                </div>
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label ">Nom d'étudiant</label>
                                                        <div class="col-sm-10">
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Modules</label>
                                                        <div class="col-sm-10">
                                                    <div  id="subject">
