...
$status=1;
$pass=$_POST['pass'];
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ClassId,DOB,Status,Pass) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:dob,:status,:pass)";
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Ajouter un étudiant</h2>
