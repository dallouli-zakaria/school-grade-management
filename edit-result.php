...
$msg="Les résultats ont été mises à jour avec succès";
}
}
}
...
<html lang="en">
    <head>
        ...
        <title>Mettre à jour un résultat</title>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Informations sur le résultat</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Mettre à jour un résultat</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Mettre à jour un résultat</h5>
                                                </div>
                                            </div>
...
{  ?>
                                            ...
                                            <label for="default" class="col-sm-2 control-label">Filière</label>
                                                        <div class="col-sm-10">
<?php echo htmlentities($row->ClassName)?> <?php echo htmlentities($row->Section)?> (Bac+<?php echo htmlentities($row->ClassNameNumeric)?>)
                                                        </div>
                                                    </div>
<div class="form-group">
