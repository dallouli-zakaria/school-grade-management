...
if(!empty($_POST["classid"]))
{
 ...
 ?><option value="">Sélectionner un étudiant </option><?php
...
if(!empty($_POST["classid1"]))
{
 ...
 while($row=$stmt->fetch(PDO::FETCH_ASSOC))
 {?>
  <p> <?php echo htmlentities($row['SubjectName']); ?><input type="text"  name="marks[]" value="" class="form-control" required="" placeholder="Entrer une note sur 20" autocomplete="off"></p>
...
<p>
<?php
echo "<span style='color:red'> Résultat déjà déclaré.</span>";
